...
namespace MVCCRUDWithSP.Models
{
    public class EmployeeDataAccessLayer
    {
        ...
        string connectionstring = "server=Powells-db\\Genacis2016;database=Genacis;User ID=genacis;Pwd=genacis;pooling=true;Max Pool Size=100";

        //To View All Employee detail
