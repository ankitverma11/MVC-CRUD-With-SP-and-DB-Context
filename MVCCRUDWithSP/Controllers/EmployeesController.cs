...
namespace MVCCRUDWithSP.Controllers
{
    ...
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,City,Department,Gender")] Employees employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,City,Department,Gender")] Employees employee)
        {
